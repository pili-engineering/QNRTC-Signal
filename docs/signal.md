...
信令是以 websocket 连接建立为基础建立，通过自定义的消息格式来通信，型如 type={json-data}，type为消息类型，{json-data} 为 json 结构的消息内容
...
ping={}
pong={}
客户端在收到ping消息时需主动回复pong消息，注意这里的ping/pong为信令层自定义的消息
```
...
// pcid           连接id
// iceParameters  ice信息
// iceCandidate   candidate信息
// dtlsParameters dtls信息
...
pub-tracks-res={"rpcid":"1538992159600","tracks":[{"trackid":"z_NB1higG2UYK3Ic","localid":"e5863ae3-f37b-4815-9539-a75e0b3d00d0","status":true},{"trackid":"0PNdxR5GR-_D3K_H","localid":"df19afb2-f6f2-4146-97df-657288f15567","status":true}]}
```
...
sub-tracks-res={"rpcid":"xxx","tracks":[]}
// rpcid 	消息id
// tracks 	流列表
